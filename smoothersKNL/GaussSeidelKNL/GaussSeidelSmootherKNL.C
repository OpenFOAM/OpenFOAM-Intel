...
#include "GaussSeidelSmootherKNL.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(GaussSeidelSmootherKNL, 0);

    lduMatrix::smoother::addsymMatrixConstructorToTable<GaussSeidelSmootherKNL>
        addGaussSeidelSmootherKNLSymMatrixConstructorToTable_;

    lduMatrix::smoother::addasymMatrixConstructorToTable<GaussSeidelSmootherKNL>
        addGaussSeidelSmootherKNLAsymMatrixConstructorToTable_;
}
...
Foam::GaussSeidelSmootherKNL::GaussSeidelSmootherKNL
(
...
void Foam::GaussSeidelSmootherKNL::smooth
(
