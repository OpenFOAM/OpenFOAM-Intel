...
) const
{
    ...
    return Expression::eval(
        Expression::tanh(Expression::pow4(
            Expression::min(
                Expression::min(
                    Expression::max(
                        Expression::operator*(
...
{
    return Expression::eval(
      Expression::tanh(Expression::sqr(
        Expression::min(
          Expression::max(
            Expression::operator*(
              scalar(2)/betaStar_,
              Expression::operator/(Expression::sqrt(k_), Expression::operator*(omega_, y_))
            ),
            Expression::operator*(
              scalar(500),
              Expression::operator/(
                Expression::operator/(this->mu()(), this->rho_),
                Expression::operator*(Expression::sqr(y_), omega_)
              ) 
            )
          ),
          scalar(100)
...
void kOmegaSST<BasicTurbulenceModel>::correct()
{
    ...
    volScalarField S2(
        Expression::eval(
            Expression::operator*(
                2.0,
                Expression::magSqr(Expression::symm(tgradU()))
            )
        )
    );
    ...
    volScalarField GbyNu(
        Expression::eval(
            Expression::operator&&(
                tgradU(),
                Expression::dev(Expression::twoSymm(tgradU()))
            )
        )
    );
    ...
    volScalarField CDkOmega(
        Expression::eval(
            Expression::operator*(
                2.0 * alphaOmega2_,
                Expression::operator/(
                    Expression::operator&(fvc::grad(k_)(), fvc::grad(omega_)()),
                    omega_
                )
            )
        )
...
*/
            Expression::eval(
              Expression::operator*(
                Expression::operator*(alpha,Expression::operator*(rho, gamma)),
                Expression::min(
                  GbyNu,
                  Expression::operator*(
                    (c1_/a1_)*betaStar_, 
                    Expression::operator*(
                      omega_, 
                      Expression::max(
                        Expression::operator*(a1_,omega_), 
                        Expression::operator*(b1_, 
                          Expression::operator*(F23()(), Expression::sqrt(S2))
                        )
                      )
                    )
                  )
